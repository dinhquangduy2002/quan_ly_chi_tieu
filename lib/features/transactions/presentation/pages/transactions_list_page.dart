...
class _TransactionsListPageState extends State<TransactionsListPage> {
  ...
  Future<void> _loadTransactions() async {
    ...
    try {
      ...
      if (!_isDisposed && mounted) {
        setState(() {
          _transactions = transactions.where((t) => t.userId == _currentUserId).toList();
          _error = null;
        });
      }
    } catch (e) {
  ...
  // SỬA LẠI ĐỂ LỌC THEO THÁNG VÀ FILTER
  ...
  // TÍNH TỔNG THEO TRANSACTIONS ĐÃ LỌC
  ...
  // THÊM METHOD HIỂN THỊ FILTER CATEGORY
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            _buildTimeFilter(),
            _buildSearchAndFilter(), // THAY ĐỔI THÀNH SEARCH AND FILTER
            Expanded(
              child: _isLoading
                  ? _buildLoadingState()
  ...
  // SỬA LẠI TIME FILTER CÓ THỂ CHỌN THÁNG
  Widget _buildTimeFilter() {
    final isThisMonth = _selectedMonth.month == today.month && _selectedMonth.year == today.year;
  ...
  // THAY ĐỔI THÀNH SEARCH AND FILTER
